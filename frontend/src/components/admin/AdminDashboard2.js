...
const AdminDashboard = () => {
  ...
  const renderDashboard = () => {
    ...
    return (
      <>
        <Helmet>
          <title>Admin Dashboard | Ukriti Jewells</title>
          <meta name="description" content="Admin dashboard for managing Ukriti Jewells e-commerce platform" />
        </Helmet>
            ...
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Welcome to Ukriti Jewells Admin Panel</p>
                </div>
          ...
          <div className="flex flex-col h-0 flex-1 bg-white shadow">
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              <div className="flex items-center flex-shrink-0 px-4 mb-6">
                <h1 className="text-xl font-bold text-gray-900">Ukriti Jewells</h1>
              </div>
