...
const AdminCustomerManager = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Customer Management - Admin Panel | The Alankriti</title>
        <meta name="description" content="Manage customers and track customer analytics for The Alankriti" />
      </Helmet>
