...
const Products = () => {
  ...
  const priceRanges = [
    ...
    { value: '10000-25000', label: 'NPR 10,000 - NPR 25,000' },
    { value: '25000-50000', label: 'NPR 25,000 - NPR 50,000' },
    { value: '50000-100000', label: 'NPR 50,000 - NPR 1,00,000' },
    { value: '100000+', label: 'Above NPR 1,00,000' }
  ];
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {metals.map(metal => (
                      <label key={metal.value} className="flex items-center">
                        <input
                          type="radio"
                          name="metal"
                          value={metal.value}
