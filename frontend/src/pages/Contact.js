...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPinIcon,
      title: 'Location',
      details: ['Balkumari, Lalitpur'],
      description: 'Online business with local expo presence'
    },
    {
      icon: ChatBubbleLeftRightIcon,
      title: 'WhatsApp Video Consultation',
      details: ['+977 9840254146'],
      description: 'Live chat & video consultation available'
    }
  ];
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <div>
                <h3 className="text-3xl font-bold text-gray-800 mb-6">Business Information</h3>
                
                <div className="bg-white p-8 rounded-2xl shadow-lg">
                  <h4 className="text-xl font-bold text-gray-800 mb-4">Type of Jewelleries</h4>
                  <div className="grid grid-cols-2 gap-4 text-gray-600">
                    <div className="flex items-center space-x-2">
                      <SparklesIcon className="h-5 w-5 text-amber-500" />
                      <span>Imitation Jewelry</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <SparklesIcon className="h-5 w-5 text-amber-500" />
                      <span>Brass Jewelry</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <SparklesIcon className="h-5 w-5 text-amber-500" />
                      <span>Oxidised Jewelry</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <SparklesIcon className="h-5 w-5 text-amber-500" />
              ...
              <div className="bg-gradient-to-r from-amber-50 to-rose-50 p-8 rounded-2xl">
                <h4 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
                  <ChatBubbleLeftRightIcon className="h-6 w-6 text-amber-500 mr-2" />
                  WhatsApp Consultation
                </h4>
                <p className="text-gray-600 mb-4">
                  Get personalized jewelry consultation through WhatsApp video calls. 
                  See our products live and get expert advice from the comfort of your home.
                </p>
                <a
                  href="https://wa.me/9779840254146"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center bg-green-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-600 transition-colors transform hover:scale-105"
                >
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-gray-600">40% more affordable than market prices</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircleIcon className="h-5 w-5 text-green-500 mt-1" />
                    <span className="text-gray-600">High-quality materials: Brass, oxidised metals, stainless steel</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircleIcon className="h-5 w-5 text-green-500 mt-1" />
                    <span className="text-gray-600">Personal touch with local expo presence</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircleIcon className="h-5 w-5 text-green-500 mt-1" />
                    <span className="text-gray-600">Carefully chosen and crafted designs</span>
                  </div>
                </div>
              </div>
            </motion.div>
