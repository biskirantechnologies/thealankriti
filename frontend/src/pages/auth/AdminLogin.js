...
const AdminLogin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Admin Login - The Alankriti</title>
        <meta name="description" content="Secure admin access to The Alankriti management system" />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="admin@The Alankriti.com"
