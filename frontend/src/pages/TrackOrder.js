...
const TrackOrder = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Track Your Order - The Alankriti</title>
        <meta name="description" content="Track your jewelry order with The Alankriti. Get real-time updates on your order status and delivery information." />
      </Helmet>
            ...
            >
              ...
              <div className="text-sm text-gray-500">
                ...
                <div className="flex items-center justify-center space-x-4 mt-2">
                  ...
                  <span>|</span>
                  <span>support@The Alankriti.com</span>
                </div>
              </div>
            </motion.div>
          )}
