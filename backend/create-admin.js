...
async function createDefaultAdmin() {
  try {
    ...
    // Check if admin@ukritijewells.com already exists
    const existingAdmin = await User.findOne({ email: 'admin@ukritijewells.com' });
    
    if (existingAdmin) {
      console.log('ℹ️ Admin user admin@ukritijewells.com already exists');
