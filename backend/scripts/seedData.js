...
const connectDB = async () => {
  try {
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/The Alankriti_jewells');
...
const sampleProducts = [
  {
    ...
    featured: true,
    trending: true,
    seoTitle: "Eternal Elegance Diamond Ring - The Alankriti",
...
const seedDatabase = async () => {
  try {
    ...
    console.log('\n📋 Summary:');
    console.log(`   • Admin user: ${process.env.ADMIN_EMAIL || 'admin@The Alankriti.com'}`);
