  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      doc.fontSize(28)
         ...
         .text(process.env.STORE_NAME || 'The Alankriti', 50, 50, { align: 'left' });
      ...
      doc.text(`Contact: ${process.env.STORE_EMAIL || 'info@The Alankriti.com'}`, 50, footerY + 30, { align: 'center', width: 495 });
